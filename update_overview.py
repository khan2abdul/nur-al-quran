...
file_path = r"e:\Repo\nur-al-quran\src\pages\WomenInIslam\WomenInIslamPage.tsx"

new_content = r"""// --- Overview Section Components ---
...
start_marker = "// --- Overview Section Components ---"
end_marker = "// --- Rights Section Components ---"
...
if start_pos != -1 and end_pos != -1:
    ...
    print("Successfully updated Overview Section components.")
else:
